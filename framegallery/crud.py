...
def delete_images_not_in_processed_items_list(db: Session, processed_items: list[str]) -> int:
...
def get_images(db: Session, skip: int = 0, limit: int | None = None) -> list[Image]:
